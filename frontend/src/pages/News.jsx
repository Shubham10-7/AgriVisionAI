...
export default function News() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5">
      <div><h1 className="text-2xl font-display font-bold text-gray-800">📰 Agricultural News</h1><p className="text-gray-500 mt-1">Latest updates on weather, market prices, and government schemes</p></div>
      ...
      {loading ? <div className="text-center py-12 text-gray-400">Loading news...</div> : (
